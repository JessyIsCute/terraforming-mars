...
function fakeMarket(offsetRowIsTop: boolean): MutationMarketModel {
  return {
    projectSlots: [
      undefined,
      {card: {name: CardName.PLANT_EATER}, active: true, minimumBid: 4, coveringMutationsAbove: [], coveringMutationsBelow: []},
      {card: {name: CardName.ASTEROID}, active: true, minimumBid: 3, coveringMutationsAbove: [], coveringMutationsBelow: []},
      {card: {name: CardName.BIG_ASTEROID}, active: true, minimumBid: 2, coveringMutationsAbove: [], coveringMutationsBelow: []},
      {card: {name: CardName.ICE_ASTEROID}, active: true, minimumBid: 1, coveringMutationsAbove: [], coveringMutationsBelow: []},
      undefined,
    ],
    alignedRow: [
