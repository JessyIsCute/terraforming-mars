...
const TEMPLATE_EXPECTED: CreateGameModel = {
  ...
  players: [
    ...
    {name: '', color: 'green', beginner: false, handicap: 0, first: false, team: 1},
    {name: '', color: 'yellow', beginner: false, handicap: 0, first: false, team: 0},
    {name: '', color: 'blue', beginner: false, handicap: 0, first: false, team: 1},
    {name: '', color: 'black', beginner: false, handicap: 0, first: false, team: 0},
    {name: '', color: 'purple', beginner: false, handicap: 0, first: false, team: 1},
    {name: '', color: 'orange', beginner: false, handicap: 0, first: false, team: 0},
    {name: '', color: 'pink', beginner: false, handicap: 0, first: false, team: 1},
  ],
  expansions: {
    corpera: true,
    promo: false,
