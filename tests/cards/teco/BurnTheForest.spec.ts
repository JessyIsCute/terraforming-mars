...
import {BurnTheForest} from '../../../src/server/cards/teco/BurnTheForest';
...
describe('BurnTheForest', () => {
  ...
  it('replaces a greenery with the tile, keeping placement bonuses, and gains 2 heat production', () => {
