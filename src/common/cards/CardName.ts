export enum CardName {
  ...
  // Venus Phase 2's own 46-card set (a user-designed mockup deck, filenames 50-96 in the source
  // material -- see venusphase2-cards memory). Ordered by source filename, not alphabetically.
  OVDA_REGIO_MASS_DRIVER = 'Ovda Regio Mass Driver',
  ATMO_SEQUESTER = 'Atmo Sequester',
  SOLAR_WIND_TRAP = 'Solar Wind Trap',
  VENUSIAN_INFRASTRUCTURES = 'Venusian Infrastructures',
  SYNTHETIC_BIOLOGY = 'Synthetic Biology',
  BIO_WASTE_REACTOR = 'Bio-Waste Reactor',
  IN_SITU_RESOURCE_UTILIZATION = 'In-Situ Resource Utilization',
  IMPROVED_FLOATING_SYSTEMS = 'Improved Floating Systems',
  MODULAR_QUARTERS = 'Modular Quarters',
  NEGATIVE_MASS_FLUIDS = 'Negative Mass Fluids',
  TRANSMISSION_TOWERS = 'Transmission Towers',
  HEAT_TRAPPERS_NETWORK = 'Heat Trappers Network',
  DYSON_HARROP_SATELLITE = 'Dyson-Harrop Satellite',
  COOLING_PILLARS = 'Cooling Pillars',
  IONIC_THRUSTERS_SUPPORT = 'Ionic Thrusters Support',
  NATIVE_MICROFAUNA = 'Native Microfauna',
  MENAGERIE = 'Menagerie',
  COMPUTATIONAL_BIOLOGY = 'Computational Biology',
  OUTSKIRTS = 'Outskirts',
  POLLUTION_CONTROL = 'Pollution Control',
  INTERPLANETARY_ROUTES = 'Interplanetary Routes',
  ARGON_MINE = 'Argon Mine',
  ISHTAR_ORBITING_ACADEMY = 'Ishtar Orbiting Academy',
  HIGH_PRESSURE_SUITS = 'High Pressure Suits',
  NEW_ALEXANDRIA = 'New Alexandria',
  GAS_TURBINES = 'Gas Turbines',
  SURVEYORS_TEAM = 'Surveyors Team',
  VENUS_AIRCRAFT_HAVEN = 'Venus Aircraft Haven',
  VENUS_KICKSTARTING = 'Venus Kickstarting',
  FLOATER_FACTORY = 'Floater Factory',
  STARWIND_II_TRADESHIP = 'Starwind II Tradeship',
  SISTER_COLONIES = 'Sister Colonies',
  VENUSIAN_RESEARCH_COMMITTEE = 'Venusian Research Committee',
  CALLISTO_DOCKING_STATION = 'Callisto Docking Station',
  XENON_MINE = 'Xenon Mine',
  RADON_MINE = 'Radon Mine',
  KRYPTON_MINE = 'Krypton Mine',
  NEW_ATHENS = 'New Athens',
  ALPHA_REGIO_INCUBATORS = 'Alpha Regio Incubators',
  NEW_ROME = 'New Rome',
  VENUS_TRADESHIP = 'Venus Tradeship',
  VENUSIAN_WANDERER = 'Venusian Wanderer',
  APHRODITE_SHUTTLE_BASE = 'Aphrodite Shuttle Base',
  ISHTAR_ENERGY_NETWORK = 'Ishtar Energy Network',
  ...
  // Solaris (fan)
  SIDERALIS = 'Sideralis',
  STELLATRON = 'Stellatron',
  BIONIC_AUGMENTATIONS = 'Bionic Augmentations',
  SYNTHETIC_BRAIN_CELLS = 'Synthetic Brain Cells',
  BUILDING_DEREGULATION = 'Building Deregulation',
  POWER_LINES_HUB = 'Power Lines Hub',
  CONDENSATION_PLANT = 'Condensation Plant',
  WASTE_INCINERATOR = 'Waste Incinerator',
  PLEBISCITE = 'Plebiscite',
  STELLAR_ENGINE = 'Stellar Engine',
  MARTIAN_CENSUS = 'Martian Census',
  COMPANY_NATIONALIZATION = 'Company Nationalization',
  TERRAIN_LEASE = 'Terrain Lease',
  SYNERGISTIC_FORESTS = 'Synergistic Forests',
  WANDERING_STATION_HERMES = 'Wandering Station Hermes',
  FIRST_MAN_MONUMENT = 'First Man Monument',
  AWARD_CELEBRATION = 'Award Celebration',
  BRIBERY = 'Bribery',
  MARS_ACADEMY_OF_POLITICAL_SCIENCES = 'Mars Academy of Political Sciences',
  IMMIGRATION_BUREAU = 'Immigration Bureau',
  ANTI_FRAUD_INVESTIGATION = 'Anti Fraud Investigation',
  ACE_VETERAN_SQUAD = 'Ace Veteran Squad',
  GALAXY_DEFENDERS = 'Galaxy Defenders',
  MOTHERSHIP = 'Mothership',
  HYPERSONIC_FIGHTERS = 'Hypersonic Fighters',
  SHIELDING_DRONES = 'Shielding Drones',

  // Solaris (fan) -- Galactic-tag batch
  SELF_REPLICATING_ROBOTS_SOLARIS = 'Self-Replicating Robots (Solaris)',
  ATMOSPHERIC_COMPRESSOR = 'Atmospheric Compressor',
  ORBITAL_HYDROGEOLOGIC_CANNON = 'Orbital Hydrogeologic Cannon',
  EXTRAPLANETARY_URBANIZATOR = 'Extraplanetary Urbanizator',
  EINSTEIN_ROSEN_GATEWAY = 'Einstein-Rosen Gateway',
  PLANETARY_CORE_INDUCTOR = 'Planetary Core Inductor',
  SYNTHETIC_GARGANTUA_TREES = 'Synthetic Gargantua Trees',
  ARTIFICIAL_MOON = 'Artificial Moon',
  SPACE_TELESCOPE = 'Space Telescope',
  FLAGSHIP = 'Flagship',

  // Solaris (fan) -- Turmoil party batch
  REDISTRIBUTION_OF_WEALTH = 'Redistribution of Wealth',
  CYBORGS = 'Cyborgs',
  STRONG_ARTIFICIAL_INTELLIGENCE = 'Strong Artificial Intelligence',
  COLD_FUSION_TECHNOLOGY = 'Cold Fusion Technology',
  GIANT_INDUSTRIAL_COMPLEX = 'Giant Industrial Complex',
  MARTIAN_AGRICULTURE = 'Martian Agriculture',
  TRADE_AGREEMENTS = 'Trade Agreements',
  WISH_MACHINE = 'Wish Machine',
  MANAGEMENT_CRISIS = 'Management Crisis',
