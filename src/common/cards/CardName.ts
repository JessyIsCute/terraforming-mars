export enum CardName {
  ...
  PERCUSSIVE_REACTOR = 'Percussive Reactor',
  ...
  MICRO_ENERGY = 'Micro Energy',
  MICRO_STEEL = 'Micro Steel',
  MICRO_PLANT = 'Micro Plant',
  MICRO_TITANIUM = 'Micro Titanium',
  SCAFFOLDING_FOREVER = 'Scaffolding Forever',
  CORE_MINES = 'Core Mines',
  MINERAL_FABRICATORS = 'Mineral Fabricators',
  THERMAL_SMELTERY = 'Thermal Smeltery',
  ...
  INSURANCE = 'Insurance',
  ENERGY_HARVEST = 'Energy Harvest',
  ELECTROBIC = 'Electrobic',
  MICROBETRONICS = 'Microbetronics',
  ...
  LUNAR_EXPORTS_BETTER_MARS = 'Lunar Exports:bm',
  PRISTAR_BETTER_MARS = 'Pristar:bm',
  EARLY_SETTLEMENT_BETTER_MARS = 'Early Settlement:bm',
  SELF_SUFFICIENT_SETTLEMENT_BETTER_MARS = 'Self-Sufficient Settlement:bm',
  EOS_CHASMA_NATIONAL_PARK_BETTER_MARS = 'Eos Chasma National Park:bm',
  IMMIGRATION_SHUTTLES_BETTER_MARS = 'Immigration Shuttles:bm',
  MARTIAN_RAILS_BETTER_MARS = 'Martian Rails:bm',
  NOCTIS_CITY_BETTER_MARS = 'Noctis City:bm',
  NOCTIS_FARMING_BETTER_MARS = 'Noctis Farming:bm',
  PROTECTED_VALLEY_BETTER_MARS = 'Protected Valley:bm',
  MARS_UNIVERSITY_BETTER_MARS = 'Mars University:bm',
  ...
  // Black Market: each design has 3 "printings" (:2/:3 suffixes, stripped for display --
  // see CardTitle.vue's `.split(':')[0]`) so the same design can be bought more than once by
  // the same player without colliding in PlayedCards' per-name uniqueness check.
  // Black Market: early-game tier (from game start) -- 4 printings each.
  CLASSIFIED_RESEARCH = 'Classified Research',
  CLASSIFIED_RESEARCH_II = 'Classified Research:2',
  CLASSIFIED_RESEARCH_III = 'Classified Research:3',
  CLASSIFIED_RESEARCH_IV = 'Classified Research:4',
  URANIUM_SMUGGLE = 'Uranium Smuggle',
  URANIUM_SMUGGLE_II = 'Uranium Smuggle:2',
  URANIUM_SMUGGLE_III = 'Uranium Smuggle:3',
  URANIUM_SMUGGLE_IV = 'Uranium Smuggle:4',
  SMUGGLED_REACTOR_CORE = 'Smuggled Reactor Core',
  SMUGGLED_REACTOR_CORE_II = 'Smuggled Reactor Core:2',
  SMUGGLED_REACTOR_CORE_III = 'Smuggled Reactor Core:3',
  SMUGGLED_REACTOR_CORE_IV = 'Smuggled Reactor Core:4',
  POACHED_SPECIMENS = 'Poached Specimens',
  POACHED_SPECIMENS_II = 'Poached Specimens:2',
  POACHED_SPECIMENS_III = 'Poached Specimens:3',
  POACHED_SPECIMENS_IV = 'Poached Specimens:4',
  COUNTERFEIT_CERTIFICATES = 'Counterfeit Certificates',
  COUNTERFEIT_CERTIFICATES_II = 'Counterfeit Certificates:2',
  COUNTERFEIT_CERTIFICATES_III = 'Counterfeit Certificates:3',
  COUNTERFEIT_CERTIFICATES_IV = 'Counterfeit Certificates:4',
  BLACK_ICE_HACKER = 'Black Ice Hacker',
  BLACK_ICE_HACKER_II = 'Black Ice Hacker:2',
  BLACK_ICE_HACKER_III = 'Black Ice Hacker:3',
  BLACK_ICE_HACKER_IV = 'Black Ice Hacker:4',
  PIRATE_TRADE_ROUTE = 'Pirate Trade Route',
  PIRATE_TRADE_ROUTE_II = 'Pirate Trade Route:2',
  PIRATE_TRADE_ROUTE_III = 'Pirate Trade Route:3',
  PIRATE_TRADE_ROUTE_IV = 'Pirate Trade Route:4',
  UNDERGROUND_CASINO = 'Underground Casino',
  UNDERGROUND_CASINO_II = 'Underground Casino:2',
  UNDERGROUND_CASINO_III = 'Underground Casino:3',
  UNDERGROUND_CASINO_IV = 'Underground Casino:4',
  BOOTLEG_TERRAFORMING_FORMULA = 'Bootleg Terraforming Formula',
  BOOTLEG_TERRAFORMING_FORMULA_II = 'Bootleg Terraforming Formula:2',
  BOOTLEG_TERRAFORMING_FORMULA_III = 'Bootleg Terraforming Formula:3',
  BOOTLEG_TERRAFORMING_FORMULA_IV = 'Bootleg Terraforming Formula:4',
  STOLEN_BLUEPRINTS = 'Stolen Blueprints',
  STOLEN_BLUEPRINTS_II = 'Stolen Blueprints:2',
  STOLEN_BLUEPRINTS_III = 'Stolen Blueprints:3',
  STOLEN_BLUEPRINTS_IV = 'Stolen Blueprints:4',
  ILLICIT_MINING_OP = 'Illicit Mining Op',
  ILLICIT_MINING_OP_II = 'Illicit Mining Op:2',
  ILLICIT_MINING_OP_III = 'Illicit Mining Op:3',
  ILLICIT_MINING_OP_IV = 'Illicit Mining Op:4',
  ...
  ORE_FOR_OXYGEN_RACKET_II = 'Ore-for-Oxygen Racket:2',
  ORE_FOR_OXYGEN_RACKET_III = 'Ore-for-Oxygen Racket:3',
  MELTDOWN_CONTRACT = 'Meltdown Contract',
  MELTDOWN_CONTRACT_II = 'Meltdown Contract:2',
  MELTDOWN_CONTRACT_III = 'Meltdown Contract:3',
  COMPOST_SYNDICATE = 'Compost Syndicate',
  COMPOST_SYNDICATE_II = 'Compost Syndicate:2',
  COMPOST_SYNDICATE_III = 'Compost Syndicate:3',
  GEOTHERMAL_KICKBACK = 'Geothermal Kickback',
  GEOTHERMAL_KICKBACK_II = 'Geothermal Kickback:2',
  GEOTHERMAL_KICKBACK_III = 'Geothermal Kickback:3',
  SMUGGLED_SEED_VAULT = 'Smuggled Seed Vault',
  SMUGGLED_SEED_VAULT_II = 'Smuggled Seed Vault:2',
  SMUGGLED_SEED_VAULT_III = 'Smuggled Seed Vault:3',
  HEAVY_METAL_HUSTLE = 'Heavy Metal Hustle',
  HEAVY_METAL_HUSTLE_II = 'Heavy Metal Hustle:2',
  HEAVY_METAL_HUSTLE_III = 'Heavy Metal Hustle:3',
  THERMAL_SKIM_OPERATION = 'Thermal Skim Operation',
  THERMAL_SKIM_OPERATION_II = 'Thermal Skim Operation:2',
  THERMAL_SKIM_OPERATION_III = 'Thermal Skim Operation:3',
  CORRUPT_OFFICE = 'Corrupt Office',
  CORRUPT_OFFICE_II = 'Corrupt Office:2',
  CORRUPT_OFFICE_III = 'Corrupt Office:3',
  SHELL_COMPANY = 'Shell Company',
  SHELL_COMPANY_II = 'Shell Company:2',
  SHELL_COMPANY_III = 'Shell Company:3',
  BOOTLEG_BATTERY = 'Bootleg Battery',
  BOOTLEG_BATTERY_II = 'Bootleg Battery:2',
  BOOTLEG_BATTERY_III = 'Bootleg Battery:3',

  // Black Market: late-game tier (unlocks generation 7+) -- 2 printings each.
  CARTEL_REFINERY = 'Cartel Refinery',
  CARTEL_REFINERY_II = 'Cartel Refinery:2',
  BLACKSITE_EXCAVATION = 'Blacksite Excavation',
  BLACKSITE_EXCAVATION_II = 'Blacksite Excavation:2',
  GREENHOUSE_LAUNDERING = 'Greenhouse Laundering',
  GREENHOUSE_LAUNDERING_II = 'Greenhouse Laundering:2',
  VENT_TAP_SYNDICATE = 'Vent Tap Syndicate',
  VENT_TAP_SYNDICATE_II = 'Vent Tap Syndicate:2',
  BLACK_MARKET_TERRAFORMER = 'Black Market Terraformer',
  BLACK_MARKET_TERRAFORMER_II = 'Black Market Terraformer:2',
  ROGUE_TERRAFORMING_CARTEL = 'Rogue Terraforming Cartel',
  ROGUE_TERRAFORMING_CARTEL_II = 'Rogue Terraforming Cartel:2',
  PIRATED_BLUEPRINTS = 'Pirated Blueprints',
  PIRATED_BLUEPRINTS_II = 'Pirated Blueprints:2',
  ILLICIT_FUSION_PLANT = 'Illicit Fusion Plant',
  ILLICIT_FUSION_PLANT_II = 'Illicit Fusion Plant:2',
  ...
  // Corporate Betterments (fan expansion)
  FUTURISTIC_CENTRE = 'Futuristic Centre',
  ARCHITECTURAL_CONTRACTS = 'Architectural Contracts',
  MARTIAN_SAFARI = 'Martian Safari',
  SLOW_GROWTH_PLANTATION = 'Slow-Growth Plantation',
  UNDERWATER_OUTPOST = 'Underwater Outpost',
  ASTEROID_FRAGMENTATION = 'Asteroid Fragmentation',
  WEATHER_CONTROL_CB = 'Weather Control',
  INTERPLANETARY_ADVERTISING_NETWORK = 'Interplanetary Advertising Network',
  JOVIAN_BELT_MINING_OPERATIONS = 'Jovian Belt Mining Operations',
  SEABED_EXTRACTION = 'Seabed Extraction',
  GREENERY_EMBELLISHMENT = 'Greenery Embellishment',
  VENUSIAN_COLLABORATION = 'Venusian Collaboration',
  BIOMASS_REACTOR = 'Biomass Reactor',
  GREAT_OCEAN_LABORATORY = 'Great Ocean Laboratory',
  INGEGNERI_SPAZIALI = 'Ingegneri Spaziali',
  MARTIAN_HOTELS = 'Martian Hotels',
  ROOFTOP_GARDENS = 'Rooftop Gardens',
  GREEN_AREAS_INTEGRATION = 'Green Areas Integration',
  PIPES = 'Pipes',
  LUNAR_MANTLE_EXCAVATION = 'Lunar Mantle Excavation',
  MICROBE_COLTURES = 'Microbe Coltures',
  WILD_BOARS = 'Wild Boars',
  EXCESS_WATER = 'Excess Water',
  MARKET_MANIPULATION_CB = 'Market Manipulation (Corporate Betterments)',
  PHOTOREFLECTORS = 'Photoreflectors',
  MONOPOLY_BREAKUP = 'Monopoly Breakup',
  IO_THERMALIZATION = 'Io Thermalization',
  VENUSIAN_TRANSPORTS = 'Venusian Transports',
  SEED_SHARING = 'Seed Sharing',
  COMPANY_INCENTIVES = 'Company Incentives',
  JOINT_VENTURE = 'Joint Venture',
  NUKE_AN_ASTEROID = 'Nuke an Asteroid',
  FAMILY_ADVERTISING = 'Family Advertising',
  COMPANY_RESTRUCTURING = 'Company Restructuring',
  ADVANCED_SCHOOLS = 'Advanced Schools',
  VENUSIAN_HEAT_EXCHANGERS = 'Venusian Heat Exchangers',
  MASS_URBANIZATION = 'Mass Urbanization',
  URBAN_PLANNING_STRATEGIES = 'Urban Planning Strategies',
  VENUSIAN_FLUCTUATING_PLANTS = 'Venusian Fluctuating Plants',
  TWIN_PLANET_COMMERCE_NETWORK = 'Twin Planet Commerce Network',
  ASSISTED_GROWTH_PLANTS = 'Assisted Growth Plants',
  MARTIAN_SAMPLES = 'Martian Samples',
  ENERGETIC_INFRASTRUCTURES = 'Energetic Infrastructures',
  VENUS_EARTH_PARTNERSHIP = 'Venus-Earth Partnership',
  BASE_ON_TITAN = 'Base On Titan',
  COMPANY_CARTEL = 'Company Cartel',
  VENUSIAN_ECOLOGY = 'Venusian Ecology',
  SMUGGLING_OPERATIONS = 'Smuggling Operations',
  COMPANY_MERGER = 'Company Merger',
  AITKEN_DRILLING_OPERATIONS = 'Aitken Drilling Operations',
  MARTIAN_LIZARDS = 'Martian Lizards',

  // Ides of Mars (fan expansion)
  BUDGET_RESTRICTIONS = 'Budget Restrictions',
  PRECIOUS_METAL_ASTEROID = 'Precious Metal Asteroid',
  TARGETED_RESEARCH = 'Targeted Research',
  SCIENCE_FAIR = 'Science Fair',
  PATENT_THEFT = 'Patent Theft',
  MUSEUM_OF_TERRAFORMATION = 'Museum of Terraformation',
  INDUSTRIAL_SPY = 'Industrial Spy',
  FLOATING_BASE_ON_SATURN = 'Floating Base on Saturn',
  BUDGET_MANAGEMENT = 'Budget Management',
  PLOT_CONTAMINATION = 'Plot Contamination',
  MARTIAN_HOUR = 'Martian Hour',
  COLLABORATION_CROSS_COMPANIES = 'Collaboration Cross-Companies',
  THREE_PLANETS_SYSTEM = 'Three Planets System',
  COPYLEFT = 'Copyleft',
  ADMINISTRATIVE_DELAY = 'Administrative Delay',
  INSECT_POLLINATORS = 'Insect Pollinators',
  NEW_FRONTIER = 'New Frontier',
  SMALL_DEPOSIT = 'Small Deposit',
  CORPORATE_ACQUISITION = 'Corporate Acquisition',
  INVESTMENT_INSURANCE = 'Investment Insurance',
  COLONY_SCRAPPING = 'Colony Scrapping',
  PATENT_POOLING = 'Patent Pooling',
  BACKSTABBING = 'Backstabbing',
  PUBLIC_RELATIONS = 'Public Relations',
  FLYING_GARDEN = 'Flying Garden',
  APPLIED_RESEARCH = 'Applied Research',
  SPACE_PIRATES = 'Space Pirates',
  MARTIAN_INFRASTRUCTURES = 'Martian Infrastructures',
  TERRAFORMING_OFFICE = 'Terraforming Office',
  FLYING_CORSAIRS = 'Flying Corsairs',
  HIDDEN_CITY = 'Hidden City',
  BIO_BATTERIES = 'Bio-Batteries',
  INVAK_CITY = 'Invak City',
  DRAGON_STORM = 'Dragon Storm',
  GALILEIAN_TOURISM = 'Galileian Tourism',
  TROGLOBITES = 'Troglobites',
  FREE_CITY = 'Free City',
  AMPHIBIANS_IOM = 'Amphibians (Ides of Mars)',
  SOLAR_SENATE = 'Solar Senate',
  VENUSIAN_GROUND_LABORATORY = 'Venusian Ground Laboratory',
  DARK_VEGETATION = 'Dark Vegetation',
  MARTIAN_STOCK_EXCHANGE = 'Martian Stock Exchange',
  DERIVED_PRODUCTS = 'Derived Products',
  FLOATING_RIG = 'Floating Rig',
  ENERGY_SHORTCUT = 'Energy Shortcut',
  AIR_TRANSPORT_COMPANY = 'Air Transport Company',
  GREAT_LEAP_FORWARD = 'Great Leap Forward',
  WATER_CLEANING_BACTERIA = 'Water Cleaning Bacteria',
  OVERCONSUMPTION_BENEFITS = 'Overconsumption Benefits',
  MERCURIAL_LABORATORY = 'Mercurial Laboratory',
  IN_VIVO_TESTING = 'In-Vivo Testing',
  WATER_RETAINERS = 'Water Retainers',
  SLUM = 'Slum',
  BLUE_MARS = 'Blue Mars',
  MINING_THE_BELT = 'Mining the Belt',
  TAKEOVER = 'Takeover',
  INFRASTRUCTURES = 'Infrastructures',
  NATURAL_GROWTH_CATALYST = 'Natural Growth Catalyst',
  GALAXY_EXPRESS = 'Galaxy Express',
  PLEISTOCENE_MEGAFAUNA = 'Pleistocene Megafauna',
  REPTILES = 'Reptiles',
  OBJECTIVE_MARS = 'Objective Mars',
  GALILEO_INSTITUTE = 'Galileo Institute',
  UNIVERSAL_FIGHTERS = 'Universal Fighters',

  // Rob Antilles (fan expansion)
  SUBURBS = 'Suburbs',
  HARBOR_BOREALIS = 'Harbor Borealis',
  HISTORICAL_VIDEOGRAPHIC_ARCHIVE = 'Historical Videographic Archive',
  INDUSTRIAL_METROPOLIS = 'Industrial Metropolis',
  ORC_TURBINES = 'Orc Turbines',
  MOBILE_BIOLOGICAL_DOME = 'Mobile Biological Dome',
  PARADISE_CITY = 'Paradise City',
  GREENHOUSE_LIGHTS = 'Greenhouse Lights',
  CACTI = 'Cacti',
  CORRUPTED_DELEGATE = 'Corrupted Delegate',
  ALIEN_REACTOR_ATIVATION = 'Alien Reactor Ativation',
  HUMPBACK_WHALES = 'Humpback Whales',
  UPGRADED_SAWS = 'Upgraded Saws',
  LAUNCH_OF_THE_PHOENIX = 'Launch of the Phoenix',
  UTOPIA_PLANITIA_SPACEPORT = 'Utopia Planitia Spaceport',
  MARTIAN_ARMED_FORCES = 'Martian Armed Forces',
  EXCAVATION_SYRIA_PLANUM = 'Excavation Syria Planum',
  WEATHER_CONTROL_TOWER = 'Weather Control Tower',
  CLOUD_CITY_RA = 'Cloud City',
  BATTLE_OF_ZADONGA = 'Battle of Zadonga',
  TERRAFORMING_BUREAU_RESTRUCTURING = 'Terraforming Bureau Restructuring',
  DOGS_IN_SPACE = 'Dogs in Space',
  STEM_CELL_RESEARCH_CENTER = 'Stem Cell Research Center',
  TROPOSPHERIC_CITY = 'Tropospheric City',
  ROOFTOP_GARDENS_OF_NOCTIS = 'Rooftop Gardens of Noctis',
  GREAT_LIGHTHOUSE_OF_ALBA_PATERA = 'Great Lighthouse of Alba Patera',
  GREAT_FACE_OF_CYDONIA = 'Great Face of Cydonia',
  MAUSOLEUM_AT_HELLAS = 'Mausoleum at Hellas',
  STATUE_OF_VON_BRAUN_ON_OLYMPUS_MONS = 'Statue of Von Braun on Olympus Mons',
  THARSIS_COLOSSUS = 'Tharsis Colossus',
  TEMPLE_OF_GAIA_AT_ELYSIUM = 'Temple of Gaia at Elysium',
  BATTLE_OVER_MARS = 'Battle over Mars',
  LIVESTOCK_GIANT_DOME = 'Livestock Giant Dome',
  LIGHTNING_ACCUMULATORS = 'Lightning Accumulators',
  MARTIAN_RANGERS = 'Martian Rangers',
  BIOREACTORS_RA = 'Bioreactors',
  NEPTUNE_EXPEDITION = 'Neptune Expedition',
  BIOMASS_CONVERSION_PLANT = 'Biomass Conversion Plant',
  OPENING_OF_NATURAL_RESERVES = 'Opening Of Natural Reserves',
  CLONATION = 'Clonation',
  MUSK_AWARDS = 'Musk Awards',
  MONUMENT_TO_MARS = 'Monument To Mars',
  SUPERNOVA_EXPLOSION = 'Supernova Explosion',
  ORGANIC_WASTE_RECYCLING = 'Organic Waste Recycling',
  SMES_TECHNOLOGY = 'Smes Technology',
  THARSIS_PUMPING_HUB = 'Tharsis Pumping Hub',
  GREAT_MARTIAN_ARCHIVES = 'Great Martian Archives',
  PLANETARY_MUSEUM = 'Planetary Museum',
  MICROBIOTIC_OCEANIC_FAUNA = 'Microbiotic Oceanic Fauna',
  OBSERVATORY_ON_OLYMPUS_MONS = 'Observatory on Olympus Mons',
  PREHISTORIC_BEASTS = 'Prehistoric Beasts',
  GIGA_INTERFEROMETER = 'Giga Interferometer',
  MARTIAN_COMMERCIAL_SEAFLEET = 'Martian Commercial Seafleet',
  DATA_LIBRARY = 'Data Library',
  MINERAL_DEPOT = 'Mineral Depot',
  HEAVY_MACHINERY = 'Heavy Machinery',
  SEDIMENTARY_ROCKS = 'Sedimentary Rocks',
  EXTRA_VEHICULAR_ACTIVITIES = 'Extra-Vehicular Activities',
  ORBITAL_BIOLOGICAL_LABORATORY = 'Orbital Biological Laboratory',
  SPACE_ROBOTS = 'Space Robots',
  ALGORITHMIC_TRADING = 'Algorithmic Trading',
  ECOPLANTS = 'Ecoplants',
  MINING_OUTPOST = 'Mining Outpost',
  EXPORTS_FROM_AMALTHEA = 'Exports From Amalthea',
  INTERPLANETARY_CRUISE = 'Interplanetary Cruise',
  MOON_MINERAL_METROPOLIS = 'Moon Mineral Metropolis',
