...
class UnityPolicy02 implements IPolicy {
  id = 'up02' as const;
  description = 'Spend 4 M€ to gain 2 titanium or add 2 floaters to ANY card (Turmoil Unity; max 3 times per generation)';
...
class UnityPolicy03 implements IPolicy {
  id = 'up03' as const;
  description = 'Spend 4 M€ to draw a Space card (Turmoil Unity; max 3 times per generation)';
